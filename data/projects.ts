...
export const projectsData: ProjectBase[] = [
  ...
  },
  {
    ...
    demoMedia: [
      ...
      { type: "image", src: "/assets/n8n/3-automatisation-image-to-notion.png", title: { fr: "LinkedIn Scraper", en: "LinkedIn Scraper" }, description: { fr: "Chat Trigger -> Google Custom Search -> push dans Google Sheets 'Donnée LinkedIn Scrapée'.", en: "Chat Trigger -> Google Custom Search -> push to Google Sheets 'Scraped LinkedIn Data'." } }
    ]
  },
  {
